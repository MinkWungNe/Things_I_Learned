'''
    ...
    ROI (Return On Investment), an important term in marketing, especially SEO, is the ratio of profit obtained to the cost you invest. Simply put, ROI is a metric that measures what you get back compared to what you have to spend.
    By understanding the true nature of ROI, you can measure the effectiveness of your capital investment for costs such as advertising, running Adwords, or other online marketing costs.
    Since ROI is based on specific metrics, it is also a very specific measure:
    ROI = (Revenue - Cost)/Cost
    Write a program that allows users to enter Revenue and Cost and output the ROI ratio for users, and also indicate whether to invest in the project or not when knowing the ROI (assuming the minimum ROI = 0.75 to invest).
'''
def ROI(dt,cp):
    return (dt-cp)/cp
def GoiYDauTu(roi):
