...
# Câu 2
class NhanVien:
    def __init__(self, ma_so, ten, luong_co_ban):
        self.ma_so = ma_so
        self.ten = ten
        self.luong_co_ban = luong_co_ban
    
    def tinh_thuong(self, ti_le_thuong):
        return self.luong_co_ban*ti_le_thuong

# TEST
nv1 = NhanVien('001', 'Le Luong Minh Quan', 5000000)
print('Bonus (No Salary Included):', nv1.tinh_thuong(.20))